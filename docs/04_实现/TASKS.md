...
| PROJ-20260117-201 | PRD-RMP-001 | Traceability | TRACEABILITY框架 | 定义需求-任务-代码-用例-回归链路与编号规则 | PM | 待定 | P0 | TODO | 1.5 | docs/PROJ-20260117-201-traceability | - | TRACEABILITY结构与字段评审通过 | TRACEABILITY#Schema | CASES#TRACE-01 | - | 2026-01-17 | - |
| PROJ-20260117-202 | PRD-RMP-001 | Traceability | 需求→任务映射 | 填充需求到任务的映射表 | PM | 待定 | P0 | TODO | 1.0 | docs/PROJ-20260117-202-req-task | PROJ-20260117-201 | 映射覆盖P0需求 | TRACEABILITY#ReqTask | CASES#TRACE-02 | - | 2026-01-17 | - |
| PROJ-20260117-203 | PRD-RMP-001 | Traceability | 任务→用例映射 | 建立任务到测试用例映射 | QA | 待定 | P0 | TODO | 1.0 | docs/PROJ-20260117-203-task-case | PROJ-20260117-201 | 映射覆盖P0任务 | TRACEABILITY#TaskCase | CASES#TRACE-03 | - | 2026-01-17 | - |
| PROJ-20260117-204 | PRD-RMP-001 | Traceability | 回归清单规则 | 回归清单编号规则与覆盖口径 | QA | 待定 | P1 | TODO | 1.0 | docs/PROJ-20260117-204-regression | PROJ-20260117-201 | 回归编号规则评审通过 | REGRESSION_CHECKLIST#Rule | CASES#TRACE-04 | - | 2026-01-17 | - |
| PROJ-20260117-205 | PRD-RMP-001 | Arch | 追踪字段设计 | 设计需求/任务/用例关联字段 | Architect | 待定 | P1 | TODO | 1.5 | feature/PROJ-20260117-205-trace-field | PROJ-20260117-201 | 字段定义写入设计文档 | DETAIL_DESIGN#TraceField | CASES#TRACE-05 | - | 2026-01-17 | - |
